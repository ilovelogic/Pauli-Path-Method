...
$$p(C, x) = \sum_{s_0, \ldots, s_d \in \mathcal{P}_n} \mathrm{Tr}\left(|x\rangle \langle x| s_d\right) \, \mathrm{Tr}\left(s_d U_d s_{d-1} U_d^\dagger\right) \cdots \mathrm{Tr}\left(s_1 U_1 s_0 U_1^\dagger\right) \, \mathrm{Tr}\left(s_0 |0^n\rangle \langle 0^n|\right)$$
